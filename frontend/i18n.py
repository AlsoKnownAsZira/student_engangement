...
_STRINGS: dict[str, dict[str, str]] = {
    "ID": {
        ...
        "err_invalid_creds": "Email atau kata sandi salah.",
        "err_email_taken": "Email ini sudah terdaftar.",
        ...
        "quick_stats_title": "Ringkasan Statistik",
        "stat_total_videos": "Total Video",
        "stat_total_students": "Siswa Terlacak",
        "stat_avg_engagement": "Rata-rata Keterlibatan",
        "quick_start_title": "🚀 Panduan Cepat",
        "qs_step1": "**1. Siapkan & Upload:** Pilih video kelas berformat MP4 di halaman Upload.",
        "qs_step2": "**2. Biarkan AI Bekerja:** Sistem otomatis mendeteksi, melacak, & menganalisis keterlibatan.",
        "qs_step3": "**3. Lihat Hasil:** Buka Riwayat untuk melihat grafik laporan dan unduh video beranotasi.",
    ...
    "EN": {
        ...
        "stat_total_students": "Students Tracked",
        "stat_avg_engagement": "Avg Engagement",
        "quick_start_title": "🚀 Quick Start Guide",
        "qs_step1": "**1. Prepare & Upload:** Select an MP4 classroom video on the Upload page.",
        "qs_step2": "**2. Let AI Work:** The system automatically detects, tracks, and analyzes engagement.",
        "qs_step3": "**3. View Results:** Go to History to see report charts and download annotated video.",
